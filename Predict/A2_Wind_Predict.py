...
def wind_predict():
    ...
    date_range_df = get_forecast(API_KEY, CITY_LIST[0], TIME_STEPS_PREDICT, COL_LIST_WEATHER_PREDICT + ["date_utc"])
    ...
    for city in CITY_LIST:
        weather_forecast_temp = get_forecast(API_KEY, city, TIME_STEPS_PREDICT, COL_LIST_WEATHER_PREDICT)
